...
At the images below we see that p values are grater than 0,05 at each lots those are null because all p values are bigger than 0,05. So these analysis are null.
