...
At the two images below we see the manifacturing lots and overall summary of our project. However as p values are grater than 0,05 at each lots those are null because all p values are bigger than 0,05
